...
\begin{threeparttable}
    ...
    \begin{tabular}{l|c|c|c|c|c|c|c|c}
        Name         & Vendor   & Type  & Series    & \multicolumn{1}{|p{1cm}|}{\centering Core \\ Count}     & \multicolumn{1}{|p{3cm}|}{\centering Clock Frequency (\SI{}{\mega\hertz})\\(min/max/turbo)}  &\multicolumn{1}{|p{2.5cm}|}{\centering Cache (\SI{}{\kibi\byte})\\ (L1/L2/L3)} & \multicolumn{1}{|p{1cm}|}{\centering TDP \\ (\SI{}{\watt})} & Launch Date\\\hline
