...
\end{threeparttable}
\end{table*}
\todo{update fft summary and workscales}
...
\todo{add more about dwt and its uses}
...
\todo{hide cfd specifics as it's not making an appearance in this paper}
\todo{add brief write up for crc}
