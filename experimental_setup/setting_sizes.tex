...
The reasons for a range of problem sizes was to examine the memory heirachy accross a range of devices, unfortunately for a number of reasons the 3 applications mentioned here fail to meet this standard.
