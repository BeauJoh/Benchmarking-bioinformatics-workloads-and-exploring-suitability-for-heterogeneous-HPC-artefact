...
We are interested in workload characterization, performance prediction and scheduling of scientific application codes for heterogeneous HPC architectures.
To evaluate different approaches we require a diverse benchmark suite which is portable to a wide variety of devices.
