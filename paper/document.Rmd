...
To better understand the performance results for selected bioinformatics benchmarks, we analyzed the codes using the Architecture Independent Workload Characterization tool [@johnston2018aiwc].
