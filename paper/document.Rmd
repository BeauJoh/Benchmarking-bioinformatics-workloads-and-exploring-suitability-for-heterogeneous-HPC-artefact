...
Additionally, we examine a bioinformatics based subset of the OpenDwarfs codes and the architecture-independent characteristics of each.
This is performed to gain insights around the suitability of heterogenous computing nodes for bioinfomatic workloads, and shows the best and worst characteristics of these codes when using accelerators.
"
author: 
...
\begin{figure*}
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{figures/aiwc-results/nw}
        \caption{\texttt{nw}\label{fig:aiwc-nw}}
    \end{subfigure}%
    ~
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{figures/aiwc-results/sw-without-setZero}
        \caption{\texttt{swat}\label{fig:aiwc-swat}}
    \end{subfigure}

        \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{figures/aiwc-results/gem}
        \caption{\texttt{gem}\label{fig:aiwc-gem}}
    \end{subfigure}%
    ~
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{figures/aiwc-results/kmeans}
        \caption{\texttt{kmeans}\label{fig:aiwc-kmeans}}
    \end{subfigure}

        \begin{subfigure}{0.55\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{figures/aiwc-results/hmm}
        \caption{\texttt{hmm}\label{fig:aiwc-hmm}}
    \end{subfigure}
