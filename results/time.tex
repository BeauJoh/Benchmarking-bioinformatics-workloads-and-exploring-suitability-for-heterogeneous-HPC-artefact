...
\vspace{-2cm}
    \begin{tabular}{lr}
        ...
        \multicolumn{2}{c}{\subcaptionbox{{\bf crc} \label{fig:time-crc}}{\includegraphics[width=.5\textwidth]{figures/time-results/crc.pdf}}} \\
    \end{tabular}
    \caption{Kernel execution times for all applications}
\end{figure}
