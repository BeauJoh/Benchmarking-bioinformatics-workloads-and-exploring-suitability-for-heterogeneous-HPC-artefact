...
%For instance, s
Some applications contain more than one kernel being executed on the accelerator device, an iteration is the sum of all compute time spent on the accelerator for all kernels.
