...
Preliminary results and analysis are reported for eight benchmark codes on a representative set of current architectures -- two Intel CPUs, 5 NVidia GPUs and a Xeon Phi.
